...
const ICONS = {
  underConstruction: (props?: IconProps) => (
    <svg
      {...props}
      width="761"
      height="301"
    ...
    <div className="h-screen w-full flex items-center justify-center py-16 px-4 md:py-24 md:px-20">
      ...
      <div className="z-10 flex flex-col items-center justify-center gap-6 md:gap-8">
        ...
        <div className="flex justify-center">
          <button
            onClick={() => navigate("/")}
            className="text-white text-lg font-semibold tracking-wide bg-transparent border-2 border-white/30 rounded-full cursor-pointer transition-all duration-300 hover:scale-105 px-6 py-2 flex items-center gap-2"
          >
